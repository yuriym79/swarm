...
def devops_engineer(query: str) -> str:
    """Route deployment, CI/CD, Docker, infrastructure, and environment setup
    tasks to the DevOps specialist. Use for: Dockerfiles, GitHub Actions,
    deployment configs, and environment variable management."""
    try:
